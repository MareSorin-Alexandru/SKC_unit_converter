...
def fc_tests():
    ...
    assert_almost_equal_float(fuel_economy_func_map.get("fc_l100kmus_mpg")(16),14.7)

    print("l100km uk_mpg 16 17.66",fc_l100kmtouk_mpg(16))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_l100kmuk_mpg")(16),17.66)

    print("l100km l100km 5 5",fc_l100KMtol100KM(5))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_l100kml100km")(5),5)


    print("us_mpg l100km 14 16.8",fc_us_mpgtol100KM(14))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_us_mpgl100km")(14), 16.8)

    print("us_mpg uk_mpg 5 6",fc_us_mpgtouk_mpg(5))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_us_mpguk_mpg")(5),6)

    print("us_mpg us_mpg 5 5",fc_us_mpgtous_mpg(5))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_us_mpgus_mpg")(5),5)


    print("uk_mpg l100km 14 20.18",fc_uk_mpgtol100km(14))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_uk_mpgl100km")(14), 20.18)

    print("uk_mpg us_mpg 14 11.65",fc_uk_mpgtous_mpg(14))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_uk_mpgus_mpg")(14),11.65)

    print("uk_mpg uk_mpg 22 22",fc_uk_mpgtouk_mpg(22))
    assert_almost_equal_float(fuel_economy_func_map.get("fc_uk_mpguk_mpg")(22),22)